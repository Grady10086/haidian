...
license: "CC-BY-4.0"
summary: "方案坚持城市织体先行、智能应用有序织入，以百年京张公共空间和普通服务为经，以三条区域协同廊道为纬，把AI作为可准入、可暂停、可解编的技术线程；由AI原点组织问题、众智园独立验证、大钟寺稳妥转化，并以原点大厦一处既有装修已通过联合验收的展厅作为优先对接候选载体开展百日限定验证。"
tracks: ["ai-traffic-walkability", "enterprise-services-ecosystem", "civic-agent-governance"]
iteration: "2026.08.29"
---

# 轨迹织城：百年京张 AI 创新带城市更新与协同转化方案

## 总体判断：城市织体先行，智能应用有序织入

百年前，京张铁路以工程理性回应复杂山势；今天，百年京张 AI 创新带应以城市尺度和公共利益校准技术应用。**轨迹织城 / RailWeave Open City**以连续公共空间为城市经线，以清河、小月河与高校、转河三条区域协同廊道为城市纬线，以可准入、可暂停、可解编的 AI 应用为技术线程，形成“一轴三廊三核、三链协同”的总体结构。先完善公共空间、普通服务和区域协同，再根据真实需求有序织入智能应用；智能系统暂停时，城市基本服务仍保持连续。

AI 在规划阶段承担资料分级、空间备选生成、跨层约束冲突识别、服务场景复演和指标异常提示；规划师与专业团队负责空间定界、方案比选和专项核验，有权主体负责转段决定，受影响公众参与公共价值判断。**AI 提供备选和证据，不替代规划审定、专业结论与行政决策。**[source:OFFICIAL-ANNOUNCEMENT] [source:AGENT-TASKBOOK] [depth:three_level_scope_framework]

![轨迹织城总览｜不断线的城市经纬与可退出AI线程](assets/figures/site-overview.png)

> **这张图怎么看。** 先看纵向京张公共经线，再看三条协同纬线；AI 原点、众智园和大钟寺不是三个并列园区，而是同一项目从“提出问题—独立验证—首用转化”的三个节点。图中边界和组件均为研究阶段建议，不是法定红线或建设承诺。

| 首读维度 | 本次成果已形成 | 下一步依法核验 |
|---|---|---|
| 空间设计 | 43.6 km² 区域定链、11.4 km² 走廊织网、三处重点区项目落位 | 正式边界、权属、现状测绘和专项条件 |
| AI 规划 | “资料分级—生成备选—六则筛选—专业选择—现场反馈”人机协同闭环 | 数据许可、模型版本、专业复核和发布权限 |
| 实施准备 | 识别原点大厦裙房一层已完成联合验收的展厅为优先对接候选载体；核实既有装修招标人，并将“展厅—北门—社区大街”确定为首期踏勘线索；形成百日限定验证、六个工作环节、六类成本包和全过程验收 | RailWeave场地授权、责任主体、展厅内S06实际可用边界、现场路线与无障碍基线、工程量、项目报价和参与授权 |
| 公共价值 | 普通服务不断线，无账号、可拒绝、可申诉、可恢复 | 六类使用群体同任务走查和现场基线 |

### 首期行动建议：一处真实载体、一个公共服务场景、百日限定验证

首期不同时启动三处工程。经公开资料核验，优先对接候选载体明确为**海淀区中关村东路8号原点大厦（原东升大厦）裙房一层AI原点社区展厅**。既有装修招标人为北京市东升农工商总公司，资金为企业自筹；这只用于识别首轮对接对象，不等于其已接收RailWeave责任。[source:AI-ORIGIN-EXHIBITION-TENDER] 该展厅既有装修工程规模为1650平方米，已取得施工许可，并于2026年7月20日取得 `京竣联验（海）字〔2026〕1380号` 联合验收通知书。[source:AI-ORIGIN-BUILDING-RENAME] [source:AI-ORIGIN-CONSTRUCTION-PERMIT] [source:AI-ORIGIN-JOINT-ACCEPTANCE] 公开报道另记录2026年7月29日一次有组织参观：参观者在讲解员引导下参观展厅各展区，随后由原点大厦北门步出并沿AI原点社区大街步行。[source:AI-ORIGIN-EXHIBITION-OPERATING] 该“展厅—北门—社区大街”链路仅作为首期踏勘线索，不证明路线长度、连续无障碍或常态开放。本方案拟在场地方书面接收和现场核验后，围绕一条约100—150米服务路线、3—5个信息决策点和一个1:1无障碍服务湾，开展“普通服务 + 可逆AI辅助”限定验证。验证重点不是技术演示，而是同一名使用者在不注册账号、断网或拒绝AI时，能否不增加费用、不产生不合理等待和异地行程地完成同一事项。

公开证据已经把“候选载体是否有对应工程记录、既有装修工程由谁招标、是否取得施工许可并完成联合验收、官方报道曾从哪个出口进入街区”从一般假设提升为可核验事实；它仍不等于RailWeave使用授权，既有工程招标人也不自动成为本项目场地权利人、运营人或责任接收人。公开资料不证明招标范围内系统已完整安装或现状可用，更不证明开放时段、100—150米实际路线、无障碍连续性、专项消防适用性或责任主体已经落实。百日工作安排、六类成本包和全过程验收要求只在后文“首期百日限定验证”完整呈现一次。现场启动前，由有权主体依法确认权利、责任、专业条件、工程量、项目报价和参与授权；后台模拟测试与公开资料核验均不替代现场调查和法定程序。[data:visual/assets/readiness_decision_receipt.json]

### 一条主线、三个节点、一次有期限的验证

约 43.6 平方公里统筹研究范围负责区域定链，约 11.4 平方公里总体设计范围负责走廊织网，约 368.4 公顷三处重点区域负责项目落位验证。AI 原点把居民、服务单位和企业的真实问题转成可测试任务；众智园复现版本、核验安全和人工接管；大钟寺连接应用单位、合规采购、运行维护和**上线后** 90/180 日评估。中关村科技服务翼提供专业服务，小月河场景赋能翼组织公共问题反馈。[source:OFFICIAL-ANNOUNCEMENT] [source:AGENT-TASKBOOK] [depth:three_level_scope_framework]

根据现有公开资料，京张铁路遗址公园一期已开放，沿线更新和后续建设持续推进，为公共经线提供了现实基础；但连续开放、无障碍、权属和工程条件仍须逐段核验。[source:PARK-PHASE1] [source:PARK-PHASE2] 众智园、大钟寺两条历史检索记录所指页面截至 2026 年 8 月 12 日已撤稿或删除，本方案不采信其中任何具体范围、主体或实施信息；AI 原点的分布式创新载体仍有可访问的官方公开资料支撑。[source:ZHONGZHIYUAN-RENEWAL] [source:DAZHONGSI-RENEWAL] [source:AI-ORIGIN-2026]

本方案为开放共创的城市设计研究成果。约 11.4 平方公里临时工作边界、三处重点区工作窗和所有功能组件均用于方案组织与技术校核，不替代法定规划、现场调查、专业审查、行政审批、采购决定或工程设计。AI 生成概念图不作为现状证据；机器验证只检查提交包规则一致性，不证明现场有效、合法或安全。[source:SOURCE-REGISTRY] [depth:existing_conditions_diagnosis]
...
|---|---|---|---|---|
| **L1 正式法定或批准依据** | 经批复、正式划定或正式审核且机构具有直接职权 | 仅在文件适用地块/河段/工程内使用“已许可、已验收、审核要求” | 只有取得正式坐标或附图才画实线 | 清华园车站文字保护要求；蓝景丽家局部实施资料；原点大厦一层展厅施工许可，均不得外推 [source:QINGHUAYUAN-HERITAGE] [source:LANJING-IMPLEMENTATION] [source:AI-ORIGIN-CONSTRUCTION-PERMIT] |
| **L2 官方项目事实与阶段状态** | 政府或法定运营主体发布的工程、更新和阶段统计 | 使用“截至某日官方口径显示”，保留日期与项目范围 | 点划线节点或已实施区段，不代替法定界线 | 京张公园一二期 [source:PARK-PHASE1] [source:PARK-PHASE2]；原点大厦一层展厅联合验收及2026年7月29日一次有组织参观记录 [source:AI-ORIGIN-JOINT-ACCEPTANCE] [source:AI-ORIGIN-EXHIBITION-OPERATING] |
...
- **首期候选载体**：原点大厦裙房一层AI原点社区展厅的地址、既有装修工程规模1650平方米、施工许可和联合验收均有公开记录。[source:AI-ORIGIN-BUILDING-RENAME] [source:AI-ORIGIN-CONSTRUCTION-PERMIT] [source:AI-ORIGIN-JOINT-ACCEPTANCE] 既有装修招标人为北京市东升农工商总公司、资金为企业自筹；该建设关系只形成首轮对接线索，不代表RailWeave责任接收。[source:AI-ORIGIN-EXHIBITION-TENDER] 公开报道另记录2026年7月29日一次有组织参观及“展厅—北门—AI原点社区大街”步行链路；该记录只作为踏勘线索，不作为路线长度、连续无障碍或开放时段证明。[source:AI-ORIGIN-EXHIBITION-OPERATING] 既有装修工程招标范围列明互动查询、会议预约、政务网络、显示、门禁、机电与消防系统；该范围仅形成现场核查清单，不证明相应系统已完整安装、现状可用、容量满足或可由S06接入。
- **周边实施基础**：AI原点社区周边约1.7万平方米整治的公开完工量包括871米新建或修复人行步道、16处1080个非机动车位、270米拆围和约4700平方米释放空间；上述数字不等于我方测绘、连续无障碍验收或全天开放承诺。[source:AI-ORIGIN-STREET-COMPLETION]
...
`KEY-001/002/003` 仅作为三处重点区域工作索引，三处重点区域数量按任务要求进行内部校核。[data:geometry/key_areas.geojson#KEY-001] [data:geometry/key_areas.geojson#KEY-002] [metric:key_area_count] 第三处索引与前两处采用同一临时边界规则。[data:geometry/key_areas.geojson#KEY-003]
...
| 六项专项任务 | 正文、空间数据、指标、图纸、网页和自检互相指向 | 以结构化矩阵和持久化回执复核 | 数字门禁通过不代表专业审批通过 |

六项专项任务采用统一证据口径，避免以概念表述代替必需成果：

| 专项任务 | 投稿阶段必交付成果 | 评审入口 | 对象编号与工作状态 |
|---|---|---|---|
| 专项任务一 总体概念与功能统筹 | 一轴三廊三核总体设计、三核两翼功能统筹、空间—运营对象交叉索引 | `overall-design-plan.png`；`ecosystem_operating_map.json`；`implementation_register.json` | `SITE-001`、三核、`RW-A01/RW-B01/RW-C01`、`G0—G6`；概念响应已形成，正式边界和实施主体待核 |
| 专项任务二 AI 全栈创新生态 | 三核×两翼×八要素运营图、开发者社区五步链、证据门和知识回流 | `ecosystem_operating_map.json`；`annual_operations_register.json` | `EL-LAND/EL-SPACE/EL-INDUSTRY/EL-FUNDING/EL-TALENT/EL-COMPUTE/EL-DATA/EL-SCENARIO`、`DEV-CHAIN-01—05`；资源供给、许可和运营主体待核 |
| 专项任务三 AI+场景与活力城市 | 十二类场景契约、三项实施准备度原型、S06 0—100 日最小实施包 | `ai-service-blueprints.png`；`weave_contracts.json`；`s06_minimum_delivery_package.json` | `S01—S12`、`S06-MDP-P1—P4`；受控取证框架已形成，现场与专项审查待开展 |
| 专项任务四 AI 公共空间与创新地标 | 三处公共创新节点、连续可达核查段、可逆构件和无障碍导视 | `identity-landmarks.png`；`public_space.geojson`；`roads.geojson` | `PUBLIC-001—003`、`AN-001—008`、`AUD-SPINE-01—06`；位置、尺寸、供电和审批待核 |
| 专项任务五 三类文化融合叙事 | 三段可行走故事线、四类责任荣誉记录、双语与无障碍内容规则 | `culture_storyline.json`；`identity-landmarks.png` | `CS-01—03`、`RR-PROBLEM/VALIDATION/FAILURE/EXIT`；史料、版权和专业审校待核 |
| 专项任务六 全球活动与长期运营 | 五段年度运营周期、开发者接续链、国际传播和退出年鉴 | `annual_operations_register.json`；`implementation-ledger.png` | `AO-01—05`、`DEV-CHAIN-01—05`；运营主体、活动审批、预算和发布许可待核 |
...
`ROAD-001` 至 `ROAD-004` 用于表达连续性核查和空间联系任务，不作为道路、桥隧、绿道或施工线位依据。[data:geometry/roads.geojson#ROAD-001] [data:geometry/roads.geojson#ROAD-004] [metric:crosslink_count] 其内部复算长度属于 L5 概念核查线工作值，仅用于方案校核，不计入工程量、政府建设时序或法定路网。[metric:conceptual_audit_alignment_length_m] [depth:traffic_rail_slow_parking]

### 城市更新与功能倾向

总体范围按照“现状依据、开放数据辅助研判、设计建议、深化事项”四类信息组织。北部重点布局开放验证与研发协作功能，中部重点完善近校协同创新与人才服务，南部重点发展场景应用与复合服务，京张轴线及三条横向廊道承担公共空间开放和网络衔接功能。[data:geometry/land_use.geojson#LU-001] [data:geometry/land_use.geojson#LU-004]

`LU-001` 至 `LU-004` 为 L5 概念性功能分区，仅用于表达总体功能组织，不构成法定用地调整或用地平衡方案。[standard:MNR-LAND-USE-CLASSIFICATION-GUIDE] [depth:land_use_layout]
...
![三处重点区统筹与AI原点场地化平面—剖面—运营原型](assets/figures/key-areas.png)
...
**现状基础与工作重点。** 众智园历史检索记录所指官方页面已撤稿或删除，现无法核验其原始表述；本方案不援引或采信其中任何具体范围、节点或实施信息。图中 `KEY-001` 仅为征集任务下的工作索引，不作为公示红线或已核实边界使用。[source:ZHONGZHIYUAN-RENEWAL] [source:OFFICIAL-ANNOUNCEMENT] [data:geometry/key_areas.geojson#KEY-001]
...
空间组织划分公众观察、结果说明、受控测试和设备后勤四类界面。公众与试验活动不共用无管理边界的通道；高风险设备应具备围合、急停、保险、应急到达和独立复核条件。`geometry/public_space.geojson` 中 `DC-*` 对象仅以可迁移概念锚点表达验证空间与公众观察界面，不构成建筑轮廓、测试资质或场地授权；室外慢行和机器人测试须另行完成交通、消防、保险及公共安全论证。
...
**现状基础与工作重点。** 根据官方信息，AI 原点是以五道口为核心、整合多个载体并向周边辐射的约3平方公里分布式创新网络，已具备企业服务、人才服务和人机协同服务窗口等实践基础。[source:AI-ORIGIN-2026] [source:AI-ORIGIN-TALENT-STATION] 原点大厦位于中关村东路8号；其裙房一层AI原点社区展厅的既有装修工程规模为1650平方米，具有施工许可和联合验收记录。[source:AI-ORIGIN-BUILDING-RENAME] [source:AI-ORIGIN-CONSTRUCTION-PERMIT] [source:AI-ORIGIN-JOINT-ACCEPTANCE] 公开报道另记录2026年7月29日一次有组织参观。[source:AI-ORIGIN-EXHIBITION-OPERATING] 另有官方活动记录将“AI原点社区A座B1”标为成府路45号，该记录与中关村东路8号展厅记录分别登记，宗地、楼座和资产关系待核，不互换房号、步行距离或开放条件；人才服务流动站的公开资料尚未披露精确楼栋和房间。[source:AI-ORIGIN-CHENGFU45-ACTIVITY] `KEY-002`仅表达工作范围，不代表法定边界。[data:geometry/key_areas.geojson#KEY-002]

**规划建议。** 建议将原点大厦裙房一层展厅作为首轮场地对接、联合踏勘和低扰动服务验证的优先候选，不再另行假定一处不明共享首层。既有装修工程招标范围列明互动查询、会议预约、政务网络、显示、门禁、机电与消防等系统，仅作为现场核查清单；首期优先核查可复用条件，只研究不改结构、低负荷、可断电、可撤除的服务层界面，任何接入仍须由权利人、物业、运营和专业人员书面确认。[source:AI-ORIGIN-EXHIBITION-TENDER] 在此基础上，可进一步论证“创新需求与成果转化服务室”以及需求受理、开源复现、成果转化、限期概念验证和人才综合服务等功能接口。拟纳入项目应具备明确服务对象和合法数据来源，完成初步研判后方可建议转入众智园测试验证、继续研究储备或形成终止评估意见。

![AI原点分布式需求协同网络研究性总平与候选展厅服务层界面](assets/figures/ai-origin-detail.png)

AI 原点采用“网络”而非“新园区”表达。首期以原点大厦一层展厅为优先候选界面，配置人工服务台、纸质与数字并行的需求墙、共同定义工坊和可撤除信息点；其余载体以服务转介和步行联系组织。公开工程记录证明该载体已取得施工许可并完成联合验收，但不证明本方案使用权、现状系统容量、常态开放时段、无障碍路径、等候容量、疏散条件或新增布置的审批适用性，上述事项仍须现场和档案核验。几何圆或临时工作窗不得解释为真实服务半径。
...
**深化条件。** 载体产权、展厅内S06实际可用边界、租金、夜间噪声、消防、公平准入、知识产权和居民意愿尚待确认。高校及园区连通和具体建筑改造应在取得相关权利人同意及专业论证后确定。[source:BEIJING-URBAN-RENEWAL]

### 大钟寺：首用场景转化中心

**现状基础与工作重点。** 大钟寺历史检索记录所指官方页面已撤稿或删除，现无法核验其原始表述；本方案不援引或采信其中任何具体范围、主体、项目或资金信息。`KEY-003` 仅为征集任务下的工作索引，不作为已核实边界或主体依据。[source:DAZHONGSI-RENEWAL] [source:OFFICIAL-ANNOUNCEMENT] [data:geometry/key_areas.geojson#KEY-003] 蓝景丽家约 5.03 ha、约 9.65 万 m²及交通预测仅适用于对应实施单元，不外推至整个片区。[source:LANJING-IMPLEMENTATION] [source:LANJING-TRAFFIC]
...
三个重点区不是同一种“AI园区”的复制，而是创新链上三个不可互换的城市空间原型。每项原型均由普通公共路径、可逆项目界面、人工服务、后台受控空间和退出恢复界面组成；空间设计先回答人如何到达、停留、理解和使用，再由实施后台管理数据、模型、责任和风险。

| 重点区原型 | 可见空间序列 | 首期可逆构件 | 直接公共产出 | 深化前置条件 |
|---|---|---|---|---|
| **众智园｜可旁观的验证院** | 连续公众路径—透明安全廊—缓冲带—受控测试口袋—人工控制室 | 实体急停柱、可移动隔离栏、只读状态牌、失败档案墙、雨洪试验槽 | 公众能够理解“测什么、谁负责、何时停止”，失败记录也成为产业公共知识 | 权属、消防、疏散、测试资质、保险、设备后勤与独立复核 |
| **AI原点｜开源修补街** | 全天候前廊—需求门诊—开放零件墙—双语说明台—受控后室 | 插接轨、可移动隔断、纸质问题卡、公开回执屏、人工转介台 | 城市问题可以被受理、拆解、修补并返回公众，开放工具可被继续维护 | 共享首层权利、开放时段、服务责任、数据边界、无障碍与社区共创 |
| **大钟寺｜首用服务站厅** | 地面优先回路—静态与触觉地图—有人柜台—安静等候—申诉台 | 可逆信息棚架、触觉地图、排队状态牌、便携服务台、反馈回执架 | 公众和应用单位可比较普通服务与智能辅助，再形成采用、整改或退出意见 | 站点接口、地面通行、客流、消防、文保、真实需求、采购权限与运维责任 |

上述空间原型分别绑定 S01、S06 和 S11 实施准备度规格，并不表示技术、场地或服务已可现场运行。每项原型交付服务蓝图、空间界面图、数据流图、责任矩阵、验收与停止条件五件套，并同步登记输入、输出、模型或设备版本、数据控制者、人工接管、失败模式和场地恢复。完整字段见 `visual/assets/scenario_prototypes.json`。
...
“织入契约”和五态法属于实施后台，不取代城市设计。每张场景卡登记公共问题、普通服务保障、AI 接入、节点责任、数据禁区、人工复核、同任务替代和退出触发；F0基织、F1试织、F2风险处置、F3有序退出、F4公共留存分别对应系统标识中的基织、试织、阻断、解编和留织。`visual/assets/railweave_runner.js` 对正常、缺人工、缺普通后备、数据越界、责任漂移和退出失败等合成分支进行离线回归，结果记录在 `visual/assets/receipt.json`。这些测试只证明输入、规则与输出保持一致，真实绩效继续保持 `unknown`，须经现场基线、专业测试和有权主体复核。

S06 建议先开展 100 日限定试点：第 0 至 30 日完成场地定界、普通服务基线和1:1走查；第31至45日完成六个BoQ包、工程量、三价和RACI；第46至60日开展封闭拆编；第61至90日仅在授权成立后限量共测；第91至100日完成撤权、删数、拆机、复原和再决策。相关工程量、价格、金额和资金来源须经核验并依法确定；关键报价覆盖不足80%、退出未全价或PF未签收时不形成总价。任何阶段出现重大安全或隐私事件、人工服务不可用、无障碍关键阻断未关闭，或者场地和退出责任未明确，应立即停止转段。
...
| 人工与纸质为底、AI可关闭的多渠道服务 | 固定导视、触觉/易读信息、纸质、电话和人工渠道先行 | 只在用户自愿启用时提供最小必要建议，保留人工终审和无惩罚拒绝 | 需如实计入人工班次和维护成本，但断网可继续、动态接口可停用、普通服务可恢复 | **选定为 S06 概念原型，进入四阶段、六决策窗口受控取证** |

本比选是对服务架构的定性判断，不是现场测试结论；不对三类模式设置虚构分数。选择第三类的核心理由，是它在 AI 未启用、被拒绝、断网、故障或退出后，仍可以同一组普通服务保持基本可达性；是否真正等价，须由第 0—30 日基线和代表性用户复核证明。

#### S06 最小实施包与阶段签收

完整的四阶段、六决策窗口、RACI、控制指标和六项退出回执统一见后文“首个100日限定样布”及 `visual/assets/s06_minimum_delivery_package.json`，本节不再重复。该文件仅供依法确定的专业团队后续深化，不构成场地、数据处理、参与招募、预算、采购或上线批准。

## 用地、建筑规模与拆改留方案

### 用地与建筑指标确定原则

`land_use.geojson` 表达四类概念性功能分区，仅用于临时工作边界内的方案一致性校核，不构成法定用地布局或控规指标。[data:geometry/land_use.geojson#LU-002] [depth:land_use_layout] `buildings.geojson` 为空图层，表示现阶段尚无经核验的建筑基底数据，不表示现场不存在建筑。功能组件通过公共空间行动范围和项目接口表达，`building_footprint_area_sqm` 暂列为待核实。[data:geometry/buildings.geojson#NO-VERIFIED-BUILDING-FOOTPRINTS] [metric:building_footprint_area_sqm]
...
![受控测试园、候选展厅服务层、站前和滨水四类典型空间界面](assets/figures/section-family.png)

本方案将五类深化对象嵌入仓库规定的规范图层：`geometry/roads.geojson` 增补 `AUD-*` 核查分段和 `SEC-*` 研究性剖切线，`geometry/public_space.geojson` 增补 `AN-*` 无障碍核查节点和 `DC-*` 可迁移组件，`geometry/phasing.geojson` 增补 `PC-*` 组件级分期。全部对象均标注为 L5、`diagrammatic`、`official_boundary=false`、`NOT FOR CONSTRUCTION`，并以 `metric_inclusion=false` 排除于道路或建成量统计；未知开放、无障碍、权属、消防、运维和现状尺寸继续保持 `unknown`。典型剖面以变量 W 表达待实测宽度，不形成道路断面、建筑高度、河道蓝线或工程线位结论。
...
|---|---|---|---|---|---|
| 众智园 | 征集任务和仓库临时包络可用；历史更新公示已撤稿或删除。权属、消防、测试资质、河道及现状尺寸待核。[source:OFFICIAL-ANNOUNCEMENT] [source:ZHONGZHIYUAN-RENEWAL] | 仅在可控室内或院落经核验后组织复现与测试；公众观察、受控试验和设备后勤分界，避免将一般公共绿地直接作为测试场。 | `AN-007` 为调查锚点；`SEC-ZY-AA/BB` 以 W 表达待实测宽度，核查围合、急停、疏散和应急到达。[data:geometry/roads.geojson#SEC-ZY-AA] | `DC-ZY-001/002` 与 `PC-ZY-001/002`：先室内复现，再论证公众观察接口；均可撤除或停用。[data:geometry/public_space.geojson#DC-ZY-001] | 依法确定的场地、测试运营、独立复核、保险和应急角色分别签认；权利、消防、保险、人工接管或恢复资金任一未成立，不进入受控测试。 |
| AI 原点 | 可访问官方信息支持约 3 km² 分布式网络及现有人才服务，但具体共享首层、无障碍路径、租赁、消防和开放时段未知。[source:AI-ORIGIN-2026] [source:AI-ORIGIN-TALENT-STATION] | 不新设封闭园区；优先研究利用一处经核验的存量共享首层，把人工服务台、纸质/数字需求墙和安静交流界面连接到既有步行网络。 | `AN-005` 为调查锚点；`SEC-AI-AA/BB` 核查沿街界面、无障碍连续到达、等候、疏散和夜间噪声。[data:geometry/roads.geojson#SEC-AI-AA] | `DC-AI-001/002` 与 `PC-AI-001/002`：先启用可移动服务台和需求墙，普通服务保持等价，其他载体只做转介。[data:geometry/public_space.geojson#DC-AI-001] | 依法确定的场地权利、运营、人工服务和社区协商角色签认；完成权属、消防、开放时段、非数字渠道和无障碍核查后，方可进入 S06 限定测试。 |
| 大钟寺 | 征集任务与蓝景丽家局部资料可用；历史片区公示已撤稿或删除。站口、站外无障碍、客流、转河方向和采购权限待核。[source:OFFICIAL-ANNOUNCEMENT] [source:LANJING-IMPLEMENTATION] [source:DAZHONGSI-RENEWAL] | 先研究地面连续到达，不预设地下连接；在站前集散与既有服务空间之间组织需求、合规、首用档案和后评估接口。 | `AN-003` 为调查锚点；`SEC-DZS-AA/BB` 以 W 和峰值流线核查站前、配送、应急及滨水方向，不形成工程线位。[data:geometry/roads.geojson#SEC-DZS-AA] | `DC-DZS-001/002` 与 `PC-DZS-001/002`：先采用可移动咨询和档案组件，实体规模依据真实需求和合法场地再论证。[data:geometry/public_space.geojson#DC-DZS-001] | 依法确定的需求、场地、采购法务、运营和审计角色签认；需求、预算、采购权限、站外无障碍、90/180 日评估及退出恢复条件齐备后方可转段。 |
...
L5 提出纵轴与三条横向廊道的衔接完善建议。[data:geometry/green_space.geojson#GREEN-001] 河道蓝线、管理范围、洪水位、生态岸线和运维通道尚未取得，临水活动、照明和装置均采用可逆方式，并应通过水务、防洪和养护专项核验。[depth:blue_green_public_space]
...
1. **众智园·验证成果展示廊**：位于重点项目临时行动范围内，通过可逆展架展示通过、限用、整改和停止等验证结论。公众展示内容仅限非敏感信息，专业日志在受控环境保存。节点加强开放验证示范园与京张公共空间主轴的联系，不承担法定认证职能。[data:geometry/public_space.geojson#PUBLIC-001]
2. **AI 原点·协同创新庭院**：集中展示社区需求、研究回应、概念验证进度、不同意见和退出记录，配置可移动学习设施和纸质需求墙，保障不使用智能设备的公众同样可以参与。[data:geometry/public_space.geojson#PUBLIC-002]
3. **大钟寺·京张创新转化门户**：以铁路里程和项目编号串联历史文化、场景需求、测试验证、合同实施和 90/180 天应用评估，突出实际使用成效。具体位置、体量和媒体形式应结合站城一体化、产权、消防和文物保护要求进一步论证。[data:geometry/public_space.geojson#PUBLIC-003]
...
- **一室**：建议以原点大厦裙房一层已建成展厅为优先对接候选载体，在场地授权、专业条件、运营责任和开放时段经核验后，研究设置需求受理、技术复现、成果转化咨询和人才住房转介功能；
...
为避免三项重点项目同时铺开，本方案建议在完成场地与启动条件核验后，优先以上述中关村东路8号原点大厦裙房一层展厅作为“开源修补街”100日限定样布的候选界面。该展厅既有装修工程规模为1650平方米；样布范围不据此推定，也不占用全部既有装修工程范围。公开报道中的“展厅—北门—AI原点社区大街”步行链路只作为首期踏勘线索，其长度、连续无障碍和开放条件均须现场核验。[source:AI-ORIGIN-EXHIBITION-OPERATING] 样布只使用经重新实测并书面接收的一条约100至150米决策路线、有限前廊和受控后室，设置3至5个决策点和一个1:1无障碍服务湾。前廊保持连续通行，设置固定与触觉导向、纸质问题卡、需求门诊、开放零件墙、人工转介台和公开回执；后室仅处理经授权的材料、版本和复核工作。AI只提供建议，不替代人工受理、例外判断、申诉和停止决定。对招标范围所列消防、机电、网络和门禁系统，未核实其现状且未经相应程序不得改动。[source:AI-ORIGIN-EXHIBITION-TENDER] 展厅内S06实际可用边界、路线、点位、权属、开放时段、消防适用性和可达性均待现场与专业核验。[data:geometry/public_space.geojson#DC-AI-001]

| 相对工作段 | 空间与服务动作 | 责任和成本证据 | 验收成果 | 转段条件 |
|---|---|---|---|---|
| **0—10日｜定界接收** | 核验权属、路线、时段、消防、可达性、责任主体和普通服务 | IE对场地与恢复负责，DO对服务目的与基线负责；只建议形成基线和退出的资金门 | E0授权与场地证据、普通服务清单、用户参与方案 | 任一关键条件为未知，不进入搭建 |
| **11—30日｜基线与1:1走查** | 先搭建可撤除的固定、触觉、纸本、电话和人工界面，不接入AI | 受影响用户参与支持、值班与替补、构件数量公式和退出工程量 | E1基线、1:1无障碍服务湾、同任务走查和问题闭环 | 必要群体任一为UNKNOWN或普通服务劣化，先整改 |
| **31—45日｜清单与三价** | 确认六个BoQ包、工程量、维护班次、独立验证、保险和恢复事项 | PF对报价与采购证据负责；关键项三份同期可比价格覆盖至少80%预估成本后方可汇总 | E4报价归一化表、单一A的RACI、停止权限和签收样式 | 工程量未确认、退出未全价或报价覆盖不足，不发布总价 |
| **46—60日｜封闭拆编** | 在受控后室开展断网、过期信息、错误建议、撤权、人工接管和设备拆除演练 | IV独立签发结论，DC签收数据处理，TO仅承担技术实施 | E2版本与数据记录、故障日志、撤权删数拆机恢复回执 | 禁用数据、重大误导、人工接管或拆编失败，停止整改 |
| **61—90日｜授权限量共测** | 仅在全部授权成立后，由自愿参与者完成普通路径与AI辅助的同任务比较 | 分别核算值守、参与支持、无障碍、独立评估、法务保险、申诉和人工接管成本 | E3完成率、等待、距离、费用、求助、误导、投诉和员工负担对照 | 普通服务不得降低；严重安全、隐私、公平事件为零 |
| **91—100日｜撤权复原再决策** | 撤权、删数、拆机、恢复饰面、校正固定导视并续接人工服务 | IE签收场地恢复，IV签发独立结论，PO复核必要群体体验 | E5退出六项回执、E6 retain/modify/remove/do-not-advance决定 | 任一退出项未签收，不得扩展或转入常态运行 |

100日是相对工作段，不是已确定日历。候选展厅的地址、既有装修工程规模、联合验收及2026年7月29日一次有组织参观已有公开记录；RailWeave场地授权、展厅内S06实际可用边界、开放时段、现场无障碍与普通服务基线、责任主体、预算和运行仍未确认，因此当前仍不进入搭建或共测。详细的普通服务基线、影子验证、限量共测、停止和退出字段见 `visual/assets/s06_minimum_delivery_package.json`。本轮以“一块样布”检验总体织法，未通过不扩展到整条走廊或其他重点区。

### 分期项目包

| 阶段 | 核心项目 | 交付成果 | 进入条件 | 调整退出条件 |
|---|---|---|---|---|
| **完成启动条件后建议0至6月：建章立制与基础准备** | 研究一室、一舱、一池、四册及三核场地、责任角色和服务对象台账 | 建议形成统一项目编号、需求登记、测试、采购和退出表单及指标基线调查计划 | 场地合法使用、现场责任、需求主体、数据使用和人工回退机制均经依法确认 | 缺少需求主体、数据依据或退出经费时不进入本方案下一阶段 [data:geometry/phasing.geojson#PHASE-001] |
| **完成启动条件后建议6至18月：受控原型验证** | 可研究开展 2 至 3 期概念验证，并论证模型、端侧和封闭环境机器人验证及低风险场景应用 | 建议形成公开测试报告、依法采购或暂不采购的完整研究意见及季度风险和财务记录 | 概念验证可复现，关键事项完成独立复核，潜在应用和运维责任角色经依法确认 | 事故处置未闭环、人工负担明显增加或预算运维条件不足时暂停 [data:geometry/phasing.geojson#PHASE-002] |
| **完成启动条件后建议18至36月：评估完善与条件性扩展** | 可研究完善 AI 原点多点服务网络、众智园限定开放测试以及大钟寺实体转化和国际交流功能的必要性 | 建议形成五年项目实施台账、专业深化图纸和连续两个评估周期结果 | 权属、规划、消防、文保、交通、市政、运营收支和公众协商条件均经相应程序确认 | 实际使用不足、持续资金缺失、风险超过阈值或权利人未同意时不予扩展 [data:geometry/phasing.geojson#PHASE-003] |

本分期按照证据成熟度、可逆性和公共收益综合排序。月份从启动条件依法成立后起算，仅表达建议相对时序，不对应日历开工时间，不表示试点、预算、国际项目或扩建已经批准，也不作为政府建设时序或行政承诺。[depth:phasing_implementation]
...
项目统一执行 G0 证据与场地核验、G1 需求及公众复核、G2 受控原型、G3 独立验证、G4 依法采购或合作、G5 上线后 90/180 日评价、G6 续期整改或退出。前一阶段的责任角色、交付物、风险处置和签字条件未满足时，不建议转入下一阶段。`geometry/phasing.geojson` 中六项 `PC-*` 对象将分期落实到可迁移组件，不再以整片重点区域代表一期建设范围。

### 证据核查、责任接续与成本取证

`visual/assets/verification_handoff_register.json` 将 G0 至 G2 的“待核实”转化为 8 项可移交任务，分别覆盖撤稿来源恢复、正式边界与场地权利、京张轴连续开放和无障碍、原点大厦一层候选载体、众智园受控测试条件、大钟寺真实需求及采购前提、非 AI 服务基线和 G0 至 G6 责任接收。原点大厦一层的地址、建设和验收证据已进入交接包，下一步不再重复论证“场地是否存在”，而是由依法确定的责任主体形成场地使用、现场专业核验和恢复条件接收单。任命依据、接收回执和接收时间未形成机器记录前，不得将项目表述为已具备进场条件。[metric:verification_handoff_item_count]

公开检索进一步将 G0 的核验对象收敛到可识别范围：北京市经信部门2026年名单将“AI原点社区专精特新服务站”的运营单位列为北京市东升农工商总公司。[source:AI-ORIGIN-SME-STATION-OPERATOR-2026] 新华社报道记录，AI原点社区一楼已设置自助服务终端和一站式服务柜台，涉及创业补贴、博士后科研工作站、社保和档案等信息。[source:AI-ORIGIN-GROUND-FLOOR-SERVICE-2026] 两项资料分别形成公开登记的专项服务运营线索和社区层面普通服务基础，但不证明该柜台位于中关村东路8号候选展厅，也不表示相关单位已接收RailWeave责任；展厅开放时段、人工值守、非数字替代、无障碍连续性和系统接入仍须依法核验。
...
公开取价已由“列科目”推进到“有来源、有日期、有适用边界的市场校核”，但项目专项报价仍未形成：

| 公开取价层级 | 已核验资料 | 可用于 | 不得用于 |
|---|---|---|---|
| **同址、同楼项目** | 同一既有装修工程的全专业招标及三名中标候选人投标报价，该工程规模为1650平方米 [source:AI-ORIGIN-BUILDING-RENAME] [source:AI-ORIGIN-EXHIBITION-TENDER] [source:AI-ORIGIN-EXHIBITION-BIDS]；融HUB采购公告证明同楼位置和采购范围，成交公告证明成交金额 [source:AI-ORIGIN-RONGHUB-NOTICE] [source:AI-ORIGIN-RONGHUB-AWARD] | 识别物业手续、专业系统现场核查、安装调试、质保维护和交付科目 | 三名中标候选人投标报价不是S06三份同期同口径报价，不按面积拆单价；融HUB不作S06预算 |
| **可直接校核的设备观察值** | 三项普通平板公开成交为3290元、3883元和4000元/台 | 冻结同等规格后校核设备报价是否明显偏离公开市场 | 不含支架、软件、防护、网络、维护和退出，不直接进入总价 [source:BJ-TABLET-LENOVO-2026] [source:BJ-TABLET-HUAWEI-2025] [source:BJ-TABLET-LENOVO-2026-B] |
| **可审计分项清单模板** | 中国工艺美术馆导视标识系统升级项目中标97.5996万元，并公开序号1—32的分项报价表；第32项为0元暂列金，适用实体分项披露规格、工艺、单位、数量、单价和合价 [source:CN-MUSEUM-SIGNAGE-ITEMISED-AWARD-2025] | 校核S06导视介质、制作安装和询价表字段是否漏项 | 项目类型、材料、固定方式、消防和验收口径不同，不拆单价、不按面积或点位折算，不计入S06有效项目报价 |
| **只作量级参照的服务整包** | 可逆导视与临时展陈有公开成交案例 [source:BJ-TEMP-WAYFINDING-CAFA-2026] [source:BJ-TEMP-EXHIBIT-SEED-2026] [source:BJ-TEMP-EXHIBIT-ACCESS-2026]；无障碍服务与独立评估、专项法务和责任保险也有公开成交案例 [source:BJ-ACCESS-EVALUATION-AWARD-2026] [source:BJ-LEGAL-COUNSEL-2026] [source:BJ-PUBLIC-LIABILITY-INSURANCE-2026] | 检查工作包是否漏列搭撤、运维、参与支持、独立复核、法务、保险和恢复 | 因面积、样本、期限、资质、保额和免赔不同，不求平均、不按天折算 |

两项既有无障碍样本继续用于人工引导、现场核查和电话回访的工作范围参照，不换算单次价格或百日金额。[source:BJ-ACCESS-GUIDE-SERVICE-2026] [source:BJ-ACCESS-HOME-AUDIT-2026] S06仅在实际点位、时段、班次、用户样本、材料规格、税费、质保、维护和退出要求冻结后，按12行工程量取得不少于三份同期同口径含税报价；公开案例对“有效项目报价数”的贡献为零，当前仍不得发布确定性总价。
...
公开记录已给出候选展厅既有装修工程规模为1650平方米，但展厅内S06实际可用边界、设备清单、并发能力、人员编制和项目专项报价仍未取得，因此不给出人民币总投资结论。五年总成本采用 `TC5 = C0 + Σ(Ot + Mt + Pt + Vt + At + Rt) + U + X`：分别计入初始配置、人员运营、技术算力软件、场地设施、独立验证、公众参与与无障碍、保险应急、中期更新以及退出恢复。直接技术/设备/场地、人员运营、独立验证与合规、公众与无障碍、保险应急退出等比例区间只用于概念阶段控制，允许交叉，不得直接相加成报价；预算未批复、合同未生效或资金未到账前，不得表述为已落实。[source:BEIJING-URBAN-RENEWAL] [source:HAIDIAN-RENEWAL-GUIDE]
...
2. **既有工程事实被误读为本方案获批**：原点大厦一层展厅的既有装修工程规模1650平方米、施工许可和联合验收只适用于该既有装修工程；不得据此认定RailWeave取得场地使用权、消防及无障碍专项结论或新增布置批准。一室、一舱、一池和三处展示节点仍是项目接口与临时行动范围。[source:AI-ORIGIN-CONSTRUCTION-PERMIT] [source:AI-ORIGIN-JOINT-ACCEPTANCE]
...
- AI原点社区和人才服务站支撑分布式网络及人机协同服务机制。[source:AI-ORIGIN-2026] [source:AI-ORIGIN-TALENT-STATION] 原点大厦一层展厅的地址及更名有公开依据；其既有装修工程规模1650平方米，并具有施工许可和联合验收记录。[source:AI-ORIGIN-BUILDING-RENAME] [source:AI-ORIGIN-CONSTRUCTION-PERMIT] [source:AI-ORIGIN-JOINT-ACCEPTANCE] 公开报道另记录2026年7月29日一次有组织参观，专业系统招标范围仅用于形成现场核查清单。[source:AI-ORIGIN-EXHIBITION-OPERATING] [source:AI-ORIGIN-EXHIBITION-TENDER] 上述资料均不代表RailWeave空间授权，招标范围亦不证明相应系统已完整安装、现状可用或可由S06接入。
